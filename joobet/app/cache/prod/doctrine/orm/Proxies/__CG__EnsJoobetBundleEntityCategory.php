...
namespace Proxies\__CG__\Ens\JoobetBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Ens\JoobetBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'active_jobs', 'more_jobs', 'name', 'jobs', 'category_affiliates', 'slug', 'type', 'length', 'unique');
        }
    ...
    public function getUnique()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnique', array());
