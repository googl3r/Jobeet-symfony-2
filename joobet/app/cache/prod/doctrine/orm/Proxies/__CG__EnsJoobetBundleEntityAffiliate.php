 ...
 */
class Affiliate extends \Ens\JoobetBundle\Entity\Affiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'url', 'category_affiliates');
        }
