 ...
 */
class CategoryAffiliate extends \Ens\JoobetBundle\Entity\CategoryAffiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'category', 'affiliate');
        }
